...
public class MovieAnalysis {
    public static void main(String[] args) {
        ...
        System.out.println(movies.stream().filter(movie -> movie.getGenre().equals("SF")).mapToDouble(Movie::getRating).average().getAsDouble());
        // 결과 : 약 8.7

        System.out.println();
        // 2. 2010년 이후 개봉된 영화를 평점 내림차순으로 정렬하여 제목 리스트를 반환하기
        List<String> movie1 = movies.stream()
        ...
        List<String> movie2 = movies.stream()
                .sorted((o1, o2) -> Integer.compare(o2.getReleaseYear(), o1.getReleaseYear()))
                .limit(3)
                .map(Movie::getTitle)
                .collect(Collectors.toList());
        ...
        Map<String, Long> collect = movies.stream()

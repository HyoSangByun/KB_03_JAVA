...
public class OrderAnalysis {
    public static void main(String[] args) {
        ...
        List<Integer> answer1 = orders.stream().filter(order -> order.getTotalAmount() >= 1_000_000)
        ...
        Map<String, Double> answer2 = orders.stream().collect(Collectors.groupingBy(
        ...
        String answer3 = orders.stream().flatMap(order -> order.getProducts().stream())
        ...
        List<String> answer4 = orders.stream().filter(order -> order.getOrderDate().isAfter(LocalDate.of(2023, 4, 30)))
